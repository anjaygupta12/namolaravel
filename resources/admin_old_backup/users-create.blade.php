                    ...
                    <form method="POST" action="{{ route('admin.users-store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pin_code" class="form-control" name="pin_code" value="{{ old('pin_code') }}">
                                    <small class="form-text text-muted">Optional</small>
                                    @error('pin_code')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="pan" class="form-control" name="pan" value="{{ old('pan') }}">
                                    <small class="form-text text-muted">Optional</small>
                                    @error('pan')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="aadhar" class="form-control" name="aadhar" value="{{ old('aadhar') }}">
                                    <small class="form-text text-muted">Optional</small>
                                    @error('aadhar')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ifsc_code" class="form-control" name="ifsc_code" value="{{ old('ifsc_code') }}">
                                    <small class="form-text text-muted">Optional</small>
                                    @error('ifsc_code')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="account_holder_name" class="form-control" name="account_holder_name" value="{{ old('account_holder_name') }}">
                                    <small class="form-text text-muted">Optional</small>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="is_demo" value="1">
                                        Demo Account?
                                        <span class="form-check-sign">
                                            <span class="check"></span>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="allow_orders_beyond_high_low" value="1" checked>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="allow_orders_between_high_low" value="1" checked>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="trade_equity_as_units" value="1" checked>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" name="auto_square_off" value="1">
                                        Auto Square Off
                                        <span class="form-check-sign">
                                            <span class="check"></span>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="auto_square_off_percentage" class="form-control" name="auto_square_off_percentage" value="{{ old('auto_square_off_percentage') ?? 0 }}" step="0.01">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="notify_percentage" class="form-control" name="notify_percentage" value="{{ old('notify_percentage') ?? 0 }}" step="0.01">
