                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.brokers-store') }}" class="form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group field-user-type">
                                        ...
                                        <select name="usertype" class="form-control" required>
                                            <option value="" {{ old('usertype', $broker->broker_type ?? '') == '' ? 'selected' : '' }}>
                                                --Select User type--
                                            </option>
                                            <option value="Broker"
                                                {{ old('usertype', $broker->broker_type ?? '') == 'Broker' ? 'selected' : '' }}>
                                                Broker
                                            </option>
                                            <option value="Staff"
                                                {{ old('usertype', $broker->broker_type ?? '') == 'Staff' ? 'selected' : '' }}>
                                                Office Staff
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group field-user-type">
                                        <label class="control-label" for="user-type">Role</label>
                                        <div class="dropdown">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    value="{{ old('auto_square_off_percentage', '90.00') }}">
