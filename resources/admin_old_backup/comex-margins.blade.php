                        ...
                        <form method="POST" action="{{ route('admin.comex-margins.update', $user->id) }}" id="comexForm">
                            ...
                            <div class="row">
                                ...
                                <div class="px-3 form-check col-md-6">
                                    <div class="form-group field-mcxusers-equity">
                                       <label>
                                        <input type="checkbox" name="comex_trading_enabled" value="1"
                            ...
                            <div class="row">
                                ...
                                <div class="px-3 form-check col-md-6">
                                    <div class="form-group field-mcxusers-equity">
                                      <label>
                                            <input type="checkbox" name="forex_trading_enabled" value="1" {{ $user->forex_trading_enabled ? 'checked' : '' }}>
                                            Forex Trading
                                        </label>
                            ...
                            <div class="row">
                                ...
                                <div class="px-3 form-check col-md-6">
                                    <div class="form-group field-mcxusers-equity">
                                                <label>
                                    <input type="checkbox" name="crypto_trading_enabled" value="1" {{ $user->crypto_trading_enabled ? 'checked' : '' }}>
                                    Crypto Trading
                                </label>
