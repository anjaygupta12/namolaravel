    ...
    <div class="user-changePassword">
        <div class="card ">
            <div class="card-header card-header-success card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Delete Trade </h4>
                </div>
            </div>
            @if (session('success'))
            ...
            <div class="card-body ">
                ...
                <div>
                    You are about to delete {{ $trade->Mode }} of {{ $trade->Lots }} lots of {{ $trade->Symbol }} of
                ...
                <form action="{{ route('admin.trade-delete', [
                    'id' => $trade->Pk_id,
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit" class="btn btn-success">Delete Trade</button>
                        </div>
                    </div>
                </form>
            </div>
