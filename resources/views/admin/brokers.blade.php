                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.sub.broker.users', $val->PK_ID) }}" title="View">
                                            <i class="fa-solid fa-eye" style="color: white;    font-size: 14px;"></i>
                                        </a>

                                        <a href="{{ route('admin.brokers-edit', $val->PK_ID) }}" title="Update">
                                            <i class="fa-solid fa-edit" style="color: white;    font-size: 14px;"></i>
                                        </a>

                                        <a href="{{ route('admin.brokers-copy', $val->PK_ID) }}" title="Copy">
                                            <i class="fa-solid fa-clone" style="color: white;    font-size: 14px;"></i>
                                        </a>
                                        <a href="{{ route('admin.brokers-toggle-status', $val->PK_ID) }}"
                                            onclick="return confirm('Are you sure you want to Change status?');"
                                            title="Status">
                                            <i class="fa-solid fa-toggle-{{ $val->account_status == 0 ? 'off' : 'on' }}" style="color: white;    font-size: 14px;"></i>
                                        </a>
                                        <form action="{{ route('admin.brokers-destroy', $val->PK_ID) }}"
                                    ...
                                    <td>{{ $val->UserName }}  </td>
                                    <td>{{ $val->Name }}</td>
                                    <td>{{ $val->parent->Name }}({{$val->parent->user_id .':'. $val->parent->UserName }})</td>
