    ...
    <div class="user-changePassword">
        <div class="card ">
            <div class="card-header card-header-success card-header-text">
                <div class="card-text">
                    <h4 class="card-title">Reset User Account</h4>
                </div>
            </div>
            @if (session('success'))
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group field-changepasswordform-old_password required">
                                <input type="hidden" name="id" value=" {{ $user->Pk_id }}">
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit" class="btn btn-success">Reset User Account</button>
                        </div>
                    </div>
                </form>
            </div>
